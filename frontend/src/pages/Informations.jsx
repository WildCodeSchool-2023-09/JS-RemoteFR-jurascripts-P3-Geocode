...
function Informations() {
  return (
    <section className="informations_page">
      ...
      <div className="separation_of_elements">
        ...
        <p>
          ...
          prix par minute ou par tranche horaire, le temps pouvant être décompté
          en fonction de la durée de recharge ou de la durée du branchement (y
          compris une fois la recharge terminée…). C&apos;est la méthode de
          tarification la plus répandue car la plus facile à calculer pour les
          opérateurs de borne.
        </p>
        <p>
          <span className="underline_informations">
          ...
          prix forfaitaire pour une quantité donnée d&apos;énergie (par exemple
          10€ pour 50 kWh) ou pour un volume horaire déterminé (par exemple 1€
          pour un branchement de 10 minutes). C&apos;est une tarification
          utilisée par certains réseaux de bornes pour leurs abonnés. Elle peut
          aussi être appliquée par des commerces qui souhaitent proposer à leurs
      ...
      <p>
        ...
        équivalente à : 3,7kW, 7,4kW, 11kW ou 22kW. Attention à ne pas confondre
        la puissance de recharge rapide de votre véhicule qui n&apos;est
        compatible qu&apos;avec une prise combo CCS ou Chademo uniquement
        disponible avec des bornes de recharge rapides. Les puissances de
        recharge sont alors généralement au-dessus de 50kW.
        <br />
        Si votre véhicule est en monophasé, on vous conseil un câble monophasé.
        Si votre véhicule est triphasé, un câble triphasé sera nécessaire pour
        obtenir la puissance maximale de 22Kw. <br />
      ...
      <div className="separation_of_elements align">
        ...
        <div>
          ...
          <p>
            ...
            bornes de recharge délivrant une puissance comprise entre 3 et 6 kW.
          </p>
          <p>
      ...
      <p>
        À titre d&apos;illustration, si vous branchez la prise de votre citadine
        Peugeot e208 pendant 20 minutes à une borne délivrant une puissance de
        90 kW dans la rue, vous aurez rechargé votre batterie à hauteur de 30
        kWh, c&apos;est-à-dire de quoi rouler plus de 150 à 200 km avec ces
        véhicules électriques qui consomment entre 15 et 20 kWh/100km en
        moyenne.
      </p>
    </section>
  );
